...
parser = argparse.ArgumentParser(description="Swap tokens in a stable NG pool")
...
views = boa.load_partial(Path(BASE_DIR, "contracts", "amm", "stableswap", "views", "views_v_120.vy")).at(VIEWS)
